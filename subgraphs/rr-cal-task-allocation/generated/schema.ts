...
export class User extends Entity {
  ...
  get calendarRangesStart(): Array<BigInt> | null {
    let value = this.get("calendarRangesStart");
    if (value === null || value.kind == ValueKind.NULL) {
      return null;
    } else {
  ...
  set calendarRangesStart(value: Array<BigInt> | null) {
    if (value === null) {
      this.unset("calendarRangesStart");
    } else {
      this.set(
        "calendarRangesStart",
  ...
  get calendarRangesEnd(): Array<BigInt> | null {
    let value = this.get("calendarRangesEnd");
    if (value === null || value.kind == ValueKind.NULL) {
      return null;
    } else {
      return value.toBigIntArray();
  ...
  set calendarRangesEnd(value: Array<BigInt> | null) {
    if (value === null) {
      this.unset("calendarRangesEnd");
    } else {
      this.set(
        "calendarRangesEnd",
        Value.fromBigIntArray(value as Array<BigInt>)
