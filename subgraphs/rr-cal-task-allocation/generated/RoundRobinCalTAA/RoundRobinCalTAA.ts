...
export class UserCalendarUpdated extends ethereum.Event {
  get params(): UserCalendarUpdated__Params {
    return new UserCalendarUpdated__Params(this);
  }
}

export class UserCalendarUpdated__Params {
  _event: UserCalendarUpdated;

  constructor(event: UserCalendarUpdated) {
    this._event = event;
  }
...
export class RoundRobinCalTAA__getTaskResult {
  value0: Bytes;
  value1: BigInt;
  value2: BigInt;
  value3: i32;
...
export class RoundRobinCalTAA__getUserResult {
  value0: BigInt;
  value1: BigInt;
  value2: boolean;
  value3: boolean;
...
export class RoundRobinCalTAA extends ethereum.SmartContract {
  static bind(address: Address): RoundRobinCalTAA {
    return new RoundRobinCalTAA("RoundRobinCalTAA", address);
  }
  ...
  getTask(_taskId: Bytes): RoundRobinCalTAA__getTaskResult {
    let result = super.call(
      "getTask",
    ...
    return new RoundRobinCalTAA__getTaskResult(
      result[0].toBytes(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toI32(),
  ...
  try_getTask(
    _taskId: Bytes
  ): ethereum.CallResult<RoundRobinCalTAA__getTaskResult> {
    let result = super.tryCall(
      "getTask",
      "getTask(bytes32):(bytes32,uint256,uint256,uint8,uint256)",
      [ethereum.Value.fromFixedBytes(_taskId)]
    ...
    return ethereum.CallResult.fromValue(
      new RoundRobinCalTAA__getTaskResult(
        value[0].toBytes(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toI32(),
  ...
  getUser(_userId: Bytes): RoundRobinCalTAA__getUserResult {
    let result = super.call(
      "getUser",
      "getUser(bytes32):(uint256,uint256,bool,bool,uint256,uint256[],uint256[])",
      [ethereum.Value.fromFixedBytes(_userId)]
    );

    return new RoundRobinCalTAA__getUserResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBoolean(),
      result[3].toBoolean(),
  ...
  try_getUser(
    _userId: Bytes
  ): ethereum.CallResult<RoundRobinCalTAA__getUserResult> {
    let result = super.tryCall(
      "getUser",
      "getUser(bytes32):(uint256,uint256,bool,bool,uint256,uint256[],uint256[])",
      [ethereum.Value.fromFixedBytes(_userId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new RoundRobinCalTAA__getUserResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBoolean(),
        value[3].toBoolean(),
...
export class SetUserCalendarRangesCall extends ethereum.Call {
  get inputs(): SetUserCalendarRangesCall__Inputs {
    return new SetUserCalendarRangesCall__Inputs(this);
  }

  get outputs(): SetUserCalendarRangesCall__Outputs {
    return new SetUserCalendarRangesCall__Outputs(this);
  }
}

export class SetUserCalendarRangesCall__Inputs {
  _call: SetUserCalendarRangesCall;

  constructor(call: SetUserCalendarRangesCall) {
    this._call = call;
  }
  ...
  get rangesStart(): Array<BigInt> {
    return this._call.inputValues[1].value.toBigIntArray();
  }

  get rangesEnd(): Array<BigInt> {
    return this._call.inputValues[2].value.toBigIntArray();
  }
}

export class SetUserCalendarRangesCall__Outputs {
  _call: SetUserCalendarRangesCall;
