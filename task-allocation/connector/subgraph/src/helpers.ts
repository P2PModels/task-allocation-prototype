...
import {
    RoundRobinApp as RoundRobinContract
...
function getTaskEntityId(appAddress: Address, taskId: Bytes): string {
    return `appAddress:${appAddress.toHexString()}-taskId:${taskId.toHexString()}`
}

function getUserEntityId(appAddress: Address, userId: Bytes): string {
    return `appAddress:${appAddress.toHexString()}-userId:${userId.toHexString()}`
}

// Contract Getters

// Need taskId because task.id has a different format (<appAddress>-<taskId>)
export function populateTaskDataFromContract(appAddress: Address, task: TaskEntity | null, taskContractId: Bytes): void {
...
export function getTaskEntity(appAddress: Address, taskId: Bytes): TaskEntity | null {
...
export function getUserEntity(appAddress: Address, userId: Bytes): UserEntity | null {
...
export function getUserRejectedTaskEntity(appAddress: Address, userId: Bytes, taskId: Bytes): UserRejectedTaskEntity | null {
